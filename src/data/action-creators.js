...
export const getLoginInfo = (dispatch, emailValue, passwordValue) => {
    ...
    fetch('http://10.241.1.4:5000/api/v1/auth', {
        headers: {
...
export const getSignupInfo = (dispatch, emailValue, passwordValue, confirmPasswordValue) => {
    ...
    fetch('http://10.241.1.4:5000/api/v1/users', {
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin' : '*',
            'Access-Control-Allow-Methods' : 'GET,PUT,POST,DELETE,PATCH,OPTIONS'
...
export const calculateRequest = (dispatch) => {
    const json = '{"from": Moscow, "to": "New York", "weight": 1, "length": 1, "width": 1, "height": 1, "delivery_type": "OneDay"}';

    fetch('http://10.241.1.4:5000/api/v1/price', {
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin' : '*',
            'Access-Control-Allow-Methods' : 'GET,PUT,POST,DELETE,PATCH,OPTIONS'
